...
if ($_POST) {
    ...
    $query = mysqli_query($connection, "insert into progress_tbl(booking_id,event_status,progress_date,progress_img) values('{$booking_id}','{$event_status}','{$progress_date}','{$progress_img}')") or die(mysqli_error(($connection)));
    ...
    header('Refresh: 5; url=view-progress.php');
}
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Add Progress</div>
                            </div>
                    ...
                    <form id="myform" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <div class="card-head">
                                        <header>Add Progress</header>
                                    </div>
                                    <div class="card-body row">
                                        <div class="col-lg-6 p-t-20">
                                            <!-- <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                <input class="mdl-textfield__input" type="number" name="b_id">
                                        ...
                                        <div class="col-lg-6 p-t-20">
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                <input class="mdl-textfield__input" type="text" name="e_status">
                                                <label class="mdl-textfield__label">Event Status</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 p-t-20">
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                <input class="mdl-textfield__input" type="date" id="date" name="p_date" autocomplete="Off">
