...
if ($_POST) {
	...
	$queryu = mysqli_query($connection, "UPDATE event_tbl SET event_type='{$event_type}', event_img='{$event_img}' WHERE event_id='{$id}'") or die(mysqli_error(($connection)));
							...
							<div class="col-sm-12">
								...
								<div class="card-box">
									...
									<div class="card-body row">
										<input type="hidden" name="id" value="<?php echo $productrow['event_id']; ?>">
										<div class="col-lg-6 p-t-20">
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
												<input class="mdl-textfield__input" type="text" name="e_type" value="<?php echo $productrow['event_type']; ?>">
